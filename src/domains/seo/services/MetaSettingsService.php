...
class MetaSettingsService
{
    ...
    public function getSiteSettings(int $siteId): array
    {
        ...
        return [
            ...
            'openAiApiKeyEnv' => trim((string)($row['openAiApiKeyEnv'] ?? 'GEMINI_API_KEY')),
            'openAiModel' => trim((string)($row['openAiModel'] ?? 'gemini-2.5-flash')),
            ...
            'strategyAssetInstructions' => trim((string)($row['strategyAssetInstructions'] ?? '')),
    ...
    public function saveSiteSettings(int $siteId, array $input): void
    {
        ...
        $data = [
            ...
            'strategyAssetInstructions' => trim((string)$this->pick($input, 'strategyAssetInstructions', $current['strategyAssetInstructions'])),
    ...
    private function defaults(): array
    {
        return [
            ...
            'openAiApiKeyEnv' => 'GEMINI_API_KEY',
    ...
    private function ensureTable(): void
    {
        ...
        if (!$db->tableExists(self::TABLE)) {
            $db->createCommand()->createTable(self::TABLE, [
                ...
                'openAiApiKeyEnv' => Schema::TYPE_STRING . "(255) NOT NULL DEFAULT 'GEMINI_API_KEY'",
                'openAiModel' => Schema::TYPE_STRING . "(64) NOT NULL DEFAULT 'gemini-2.5-flash'",
                ...
                'strategyAssetInstructions' => Schema::TYPE_TEXT,
